...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me.__25.logicBlock_scaling = function() {
			...
			if (
				((player.getViewerSize().width == 845)) && 
			...
			if (me.__25.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				else if (me.__25.ggCurrentLogicStateScaling == 1) {
 ...
 let url = '';
  ...
  document.body.removeChild(textarea);
		...
		me.__11.logicBlock_size = function() {
			...
			if (me.__11.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__11.ggCurrentLogicStateSize == 0) {
					me.__11.style.width='165px';
					me.__11.style.height='165px';
				...
				else if (me.__11.ggCurrentLogicStateSize == 2) {
		...
		me._map_11.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getViewerSize().width == 845)) && 
				((player.getViewerSize().height == 540))
			...
			if (me._map_11.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._map_11.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._map_11.style.transition='left 0s, top 0s, transform 0s';
				if (me._map_11.ggCurrentLogicStatePosition == 0) {
					me._map_11.style.left = 'calc(50% - (88% / 2))';
					me._map_11.style.top = 'calc(50% - (88% / 2))';
				}
				else {
					me._map_11.style.left='calc(50% - ((88% + 0px) / 2) + 0px)';
					me._map_11.style.top='calc(50% - ((88% + 0px) / 2) - 15px)';
				}
			}
		}
		me._map_11.logicBlock_position();
		me._map_11.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				((player.getViewerSize().width == 845)) && 
				((player.getViewerSize().height == 540))
			...
			if (me._map_11.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._map_11.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._map_11.style.transition='left 0s, top 0s, transform 0s';
				if (me._map_11.ggCurrentLogicStateScaling == 0) {
					me._map_11.ggParameter.sx = 0.65;
					me._map_11.ggParameter.sy = 0.65;
					me._map_11.style.transform=parameterToTransform(me._map_11.ggParameter);
					skin.updateSize(me._map_11);
				}
				else {
					me._map_11.ggParameter.sx = 1;
					me._map_11.ggParameter.sy = 1;
					me._map_11.style.transform=parameterToTransform(me._map_11.ggParameter);
					skin.updateSize(me._map_11);
				}
			}
		}
		me._map_11.logicBlock_scaling();
		...
		me._map_11.ggCurrentLogicStatePosition = -1;
		me._map_11.ggCurrentLogicStateScaling = -1;
		...
		me._map_1.logicBlock_size = function() {
			...
			if (me._map_1.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				me._map_1.style.transition='width 0s, height 0s, transform 0s';
		...
		me._map_1.logicBlock_scaling = function() {
			...
			if (me._map_1.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me._map_1.ggCurrentLogicStateScaling == 0) {
					me._map_1.ggParameter.sx = 0.65;
					me._map_1.ggParameter.sy = 0.65;
		...
		me.__.logicBlock_size = function() {
			...
			if (me.__.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				me.__.style.transition='width 0s, height 0s, transform 0s';
				if (me.__.ggCurrentLogicStateSize == 0) {
					me.__.style.width='180px';
					me.__.style.height='43px';
					skin.updateSize(me.__);
				}
				else {
					me.__.style.width='218px';
					me.__.style.height='52px';
					skin.updateSize(me.__);
				}
			}
		}
		...
		me.__.logicBlock_scaling = function() {
			...
			if (me.__.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me.__.ggCurrentLogicStateScaling == 0) {
					me.__.ggParameter.sx = 0.85;
					me.__.ggParameter.sy = 0.85;
		...
		me._container_2.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize().width == 845)) && 
				((player.getViewerSize().height == 540))
			...
			if (me._container_2.ggCurrentLogicStateSize != newLogicStateSize) {
				me._container_2.ggCurrentLogicStateSize = newLogicStateSize;
				me._container_2.style.transition='width 0s, height 0s';
				if (me._container_2.ggCurrentLogicStateSize == 0) {
					me._container_2.style.width='120px';
					me._container_2.style.height='36px';
					me._container_2.style.top = 'calc(50% - (36px / 2))';
					skin.updateSize(me._container_2);
				}
				else {
					me._container_2.style.width='180px';
					me._container_2.style.height='54px';
					me._container_2.style.top = 'calc(50% - (54px / 2))';
					skin.updateSize(me._container_2);
				}
			}
		}
		me._container_2.logicBlock_size();
		...
		hs ='';
		hs+='height : 60.6332%;';
		hs+='left : calc(50% - ((82% + 0px) / 2) + 24px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((60.6332% + 0px) / 2) + 0px);';
		hs+='visibility : inherit;';
		hs+='width : 82%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me._image_3.logicBlock_position = function() {
			...
			if (me._image_3.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._image_3.style.transition='left 0s, top 0s';
				if (me._image_3.ggCurrentLogicStatePosition == 0) {
					me._image_3.style.left = 'calc(50% - (82% / 2) + (0px / 2) + 28px)';
					me._image_3.style.top = 'calc(50% - (60.6332% / 2))';
				}
				else {
					me._image_3.style.left='calc(50% - ((82% + 0px) / 2) + 24px)';
					me._image_3.style.top='calc(50% - ((60.6332% + 0px) / 2) + 0px)';
				}
			}
		}
